...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: '창작 속에서 평화를! 무언가를 만든다.', type: ['F', 'G'] },
  ...
  },
  {
    ...
    a: [
      { answer: '봄이 온다...', type: ['K'] },
      { answer: '그에 따른 피해는 없는지 찾아본다.', type: ['J'] },
      { answer: '물이 된다.', type: ['H'] },
